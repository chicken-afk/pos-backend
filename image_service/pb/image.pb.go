...
func (x *UploadImageRequest) GetImageData() string {
	if x != nil {
		return x.ImageData
	}
	return ""
...
const file_image_proto_rawDesc = "" +
	"\n" +
	"\vimage.proto\x12\x13image_service.proto\"R\n" +
	"\x12UploadImageRequest\x12\x1d\n" +
	"\n" +
	"image_data\x18\x02 \x01(\tR\timageData\x12\x1d\n" +
	"\n" +
	"image_name\x18\x03 \x01(\tR\timageName\"2\n" +
	"\x13UploadImageResponse\x12\x1b\n" +
	"\timage_url\x18\x01 \x01(\tR\bimageUrlB\x16Z\x14pos/image_service/pbb\x06proto3"
